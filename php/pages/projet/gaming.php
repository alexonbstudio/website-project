                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        <div class="section_title mb-20px">
                            ...
                            <h4><?php echo $trad['default']['slide']['1']['title']; ?></h4>
                        </div>
                        <p><?php echo $trad['pages']['projet']['gaming']['short-content']; ?></p>
                        <a href="<?php echo $website['info']['langs']['protocol'].'://'.$website['info']['site']['default-url'].'/'.$trad['pages']['projet']['gaming']['content']['url-full']; ?>" class="line-button"><?php echo $trad['pages']['projet']['gaming']['content']['title']; ?></a>
                    </div>
                </div>
