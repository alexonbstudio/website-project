                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        <div class="section_title mb-20px">
                            ...
                            <h4><?php echo $trad['server']['default']['title']; ?> - Minecraft (<?php echo $trad['server']['mcpe']['content']['name-serv']; ?>)</h4>
                        </div>
                        <p><?php echo $trad['server']['mcpe']['content']['info']; ?></p>
						<div class="alert alert-primary" role="alert">
							<?php echo $trad['server']['mcpe']['content']['ip-serv'].' '.$trad['server']['mcpe']['content']['port-serv']; ?>
						</div>
						<p>Option:<br /> <?php echo $trad['server']['mcpe']['content']['option']; ?></p>
						
						<p>Compatible: <a href="https://minecraft-fr.gamepedia.com/Version_Bedrock">Android, IOS, Fire OS, Gear VR, Samsung gear VR, Windows 10, Windows Phone, console</a></p>
                    </div>
                </div>
