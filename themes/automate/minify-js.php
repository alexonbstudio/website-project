...
$minifier->minify('assets/combined/js/main.js');
...
<html lang="<?php echo $DefineTranslateLang; ?>">
	<head>
		...
		<title><?php echo htmlentities($sites['name']); ?> - Automate Minify (JS)</title>
    ...
    <main role="main" class="container">
      <h1 class="mt-5">Automate Minify (JS)</h1>
      <p class="lead">Hi guest, the automate minifies/compress JS is done.<br> 
